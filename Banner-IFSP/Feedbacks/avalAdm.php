...
<body>
    <header>
        <a href="indexadm.php" class="header-left">
                ...
                <?php foreach ($feedbacks as $feedback): ?>
                    <div class="review <?php echo $feedback['visible'] ? '' : 'hidden-review'; ?>" data-id="<?php echo $feedback['id']; ?>">
                        <div class="review-header">
                            <img src="assets/<?php echo htmlspecialchars(getFeedbackIcon($feedback['feedback'])); ?>.svg" class="icon_review" alt="">
...
<?php
// Função para obter o ícone do feedback
